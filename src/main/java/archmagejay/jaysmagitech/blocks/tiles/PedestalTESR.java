...
public class PedestalTESR extends TileEntitySpecialRenderer<PedestalTileEntity> {
    ...
    private void renderArms(PedestalTileEntity te) {
        GlStateManager.pushMatrix();
        ...
        IBlockState state = ModBlocks.PEDESTAL.getDefaultState().withProperty(PedestalBlock.IS_HANDLES, true);
